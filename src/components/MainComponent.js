    	...
    	return(
    		<div className="container-fluid">
				<Navbar light expand="md">
				    <NavbarBrand style={{color: 'orangered'}} className="m-auto header">IDEA MANAGEMENT TOOL</NavbarBrand>
					<Nav navbar>
						<Button style={{backgroundColor: 'black'}} onClick={this.toggleShowGroupData}>Group Highlights</Button>
					</Nav>
				</Navbar>
